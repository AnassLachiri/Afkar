...
<br>
<h2 style="text-align: center; color: gray;">Search - <%= request.getAttribute("search_text") %></h2>
...
<div class="pagination d-flex justify-content-center align-items-center">
    <a href="search?search_text=<%= request.getAttribute("search_text") %>&page=<%= (((long)request.getAttribute("page")) -1) %>">&#60;&#60; Last Page </a> - <span> <%= request.getAttribute("page") %> </span> - <a href="search?search_text=<%= request.getAttribute("search_text") %>&page=<%= (1+(long)request.getAttribute("page")) %>"> Next Page &#62;&#62;</a>
</div>
